...
This project implements a Docker container for [MKV Muxing Batch GUI](https://github.com/yaser01/mkv-muxing-batch-gui).
...
Where:
  ...
  - `/docker/appdata/mkv-muxing-batch-gui`: This is where the application stores its configuration, states, log and any files needing persistency.
  - `/home/user`: This location contains files from your host that need to be accessible to the application.

Browse to `http://your-host-ip:5800` to access the MKV Muxing Batch GUI GUI.
...
`mkv-muxing-batch-gui.domain.tld` to the container at `127.0.0.1:5800`.
...
`server.domain.tld/mkv-muxing-batch-gui` to the container at `127.0.0.1:5800`.
